...
-- Este seed cria categorias genéricas que podem ser copiadas por cada org
-- Ou você pode criar uma org de exemplo e associar as categorias a ela
...
SELECT 
  '✅ Seed data inserido com sucesso!' as message,
  'Sistema multi-tenant com Organizations ativo' as info,
  '📝 Próximo passo: Criar sua primeira Organization via app' as next_step;
